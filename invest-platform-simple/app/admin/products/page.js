...
function ProductStrategyModal({ isOpen, onClose, product, onSave }) {
  ...
  const [form, setForm] = useState({
    maxBuyAmount: 10000,
    maxSellAmount: 10000,
    limitUpPercent: 20,    // 默认涨停 20%
    limitDownPercent: 20,  // 默认跌停 20%
    strategyType: 'market', 
          ...
          <div className="bg-gray-50 p-4 rounded-lg border">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                />
                <p className="text-[10px] text-gray-400 mt-1">0 表示无限制，防止大单拉盘</p>
              </div>
              <div>
                ...
                />
                <p className="text-[10px] text-gray-400 mt-1">0 表示无限制，防止大单砸盘</p>
              </div>
            </div>
          </div>
